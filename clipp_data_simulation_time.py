...
def run_simulation(tree = tree, clusters = cluster, n_sample = 100):
    output_root = 'multi_clipp_simulation_data_time'
    argv = {
        'n_clusters': 5,
        'n_samples': 2,
        'purity': 'uniform',
        'read_depth': 100,
        'n_mutations': n_sample, ## the union of SNVs in all regions
    ...
    output_handle = open(output_root + '%s.tsv' % (n_samples), 'w')
